...
@NamedQueries({ @NamedQuery(name = "ExamCommittee.findAll", query = "SELECT e FROM ExamCommittee e"),
...
public class ExamCommittee implements DomainObject, Serializable {
	...
	public ExamCommittee(Integer examCommitteeId, int session, int semester, int chairmanId, String startDate,
			String endDate) {
		this.examCommitteeId = examCommitteeId;
	...
	public boolean equals(Object object) {
		...
		if ((this.examCommitteeId == null && other.examCommitteeId != null)
				|| (this.examCommitteeId != null && !this.examCommitteeId.equals(other.examCommitteeId))) {
			return false;
		}
		return true;
	}
